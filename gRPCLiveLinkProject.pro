...
unrealRootPath=/mnt/Shared/moveai/repos/UnrealEngine
gRPCLiveLinkProjectRootPath=/mnt/Shared/moveai/unreal/gRPCLiveLinkProject

gameProjectFile=/mnt/Shared/moveai/unreal/gRPCLiveLinkProject/gRPCLiveLinkProject.uproject
...
include(gRPCLiveLinkProjectSource.pri)
include(gRPCLiveLinkProjectHeader.pri)
include(gRPCLiveLinkProjectConfig.pri)
include(gRPCLiveLinkProjectIncludes.pri)
include(gRPCLiveLinkProjectDefines.pri)
...
gRPCLiveLinkProject-Linux-Debug.commands = $$build gRPCLiveLinkProject Linux Debug  -project="\"$$gameProjectFile\"" $$args
gRPCLiveLinkProject-Linux-DebugGame.commands = $$build gRPCLiveLinkProject Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
gRPCLiveLinkProject-Linux-Shipping.commands = $$build gRPCLiveLinkProject Linux Shipping  -project="\"$$gameProjectFile\"" $$args
gRPCLiveLinkProject-Linux-Test.commands = $$build gRPCLiveLinkProject Linux Test  -project="\"$$gameProjectFile\"" $$args
gRPCLiveLinkProject.commands = $$build gRPCLiveLinkProject Linux Development  -project="\"$$gameProjectFile\"" $$args

gRPCLiveLinkProjectEditor-Linux-Debug.commands = $$build gRPCLiveLinkProjectEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
gRPCLiveLinkProjectEditor-Linux-DebugGame.commands = $$build gRPCLiveLinkProjectEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
gRPCLiveLinkProjectEditor-Linux-Shipping.commands = $$build gRPCLiveLinkProjectEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
gRPCLiveLinkProjectEditor-Linux-Test.commands = $$build gRPCLiveLinkProjectEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
gRPCLiveLinkProjectEditor.commands = $$build gRPCLiveLinkProjectEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	UE4Server \
	gRPCLiveLinkProject-Linux-Debug \
	gRPCLiveLinkProject-Linux-DebugGame \
	gRPCLiveLinkProject-Linux-Shipping \
	gRPCLiveLinkProject-Linux-Test \
	gRPCLiveLinkProject \
	gRPCLiveLinkProjectEditor-Linux-Debug \
	gRPCLiveLinkProjectEditor-Linux-DebugGame \
	gRPCLiveLinkProjectEditor-Linux-Shipping \
	gRPCLiveLinkProjectEditor-Linux-Test \
	gRPCLiveLinkProjectEditor \
