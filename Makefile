...
gRPCLiveLinkProject-Linux-Debug:
	 $(PROJECTBUILD) gRPCLiveLinkProject Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

gRPCLiveLinkProject-Linux-DebugGame:
	 $(PROJECTBUILD) gRPCLiveLinkProject Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

gRPCLiveLinkProject-Linux-Shipping:
	 $(PROJECTBUILD) gRPCLiveLinkProject Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

gRPCLiveLinkProject-Linux-Test:
	 $(PROJECTBUILD) gRPCLiveLinkProject Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

gRPCLiveLinkProject:
	 $(PROJECTBUILD) gRPCLiveLinkProject Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

gRPCLiveLinkProjectEditor-Linux-Debug:
	 $(PROJECTBUILD) gRPCLiveLinkProjectEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

gRPCLiveLinkProjectEditor-Linux-DebugGame:
	 $(PROJECTBUILD) gRPCLiveLinkProjectEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

gRPCLiveLinkProjectEditor-Linux-Shipping:
	 $(PROJECTBUILD) gRPCLiveLinkProjectEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

gRPCLiveLinkProjectEditor-Linux-Test:
	 $(PROJECTBUILD) gRPCLiveLinkProjectEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

gRPCLiveLinkProjectEditor:
	 $(PROJECTBUILD) gRPCLiveLinkProjectEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
